...
const STATIC_WORD =
  import.meta.env.VITE_SIGNATURE_STATIC_WORD || "EdamAna2025RO";
...
const BASE_URL =
  import.meta.env.VITE_API_BASE_URL || "https://qa.edamana.live/";
...
const verifyResponseSignature = (response) => {
  ...
  if (
    ...
    CryptoJS.enc.Hex.parse(signature).toString()
  ) {
    toast.error("غير متوافق مع استجابه الخادم");
